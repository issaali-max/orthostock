...
export const DICT = {
  ar: {
    ...
    byMargin: 'الأعلى هامشاً', byDebt: 'الأعلى ديناً', allCities: 'كل المدن', allEmirates: 'كل الإمارات', soldMaterials: 'المواد المباعة', allTypes: 'كل الأنواع',
  ...
  en: {
    ...
    byMargin: 'Top margin', byDebt: 'Top debt', allCities: 'All cities', allEmirates: 'All emirates', soldMaterials: 'Sold materials', allTypes: 'All types',
