...
export const DICT = {
  ar: {
    ...
    confirmReturn: 'إرجاع الفاتورة؟ ستعاد المواد للمخزون', stockHistory: 'سجل حركة المخزون',
  ...
  en: {
    ...
    confirmReturn: 'Return invoice? Stock will be restored', stockHistory: 'Stock movement history',
