...
export const DICT = {
  ar: {
    ...
    byMargin: 'الأعلى هامشاً', byDebt: 'الأعلى ديناً', allCities: 'كل المدن', allEmirates: 'كل الإمارات', allTypes: 'كل الأنواع',
  ...
  en: {
    ...
    byMargin: 'Top margin', byDebt: 'Top debt', allCities: 'All cities', allEmirates: 'All emirates', allTypes: 'All types',
